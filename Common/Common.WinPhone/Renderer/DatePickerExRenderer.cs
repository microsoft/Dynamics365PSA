...
[assembly: ExportRenderer(typeof(Common.View.CustomControl.DatePickerEx), typeof(Common.WinPhone.Renderer.DatePickerExRenderer))]
namespace Common.WinPhone.Renderer
{
    ...
    public class DatePickerExRenderer : DatePickerRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<DatePicker> e)
        {
            ...
            {
                var native = (Microsoft.Phone.Controls.DatePicker)Control;
