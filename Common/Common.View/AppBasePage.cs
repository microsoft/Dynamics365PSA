...
{
    /// <summary>
    /// Content page intended for use as the MainPage in an application.
    /// Provides similar functionality as AppTabbedPage without being a TabbedPage.
    /// </summary>
    public class AppBasePage : ContentPage
    {
        private bool firstAppearanceComplete = false;
        ...
        protected override async void OnAppearing()
        {
            ...
            if (!firstAppearanceComplete)
            {
                firstAppearanceComplete = true;
                await this.Refresh();
            }
        }
